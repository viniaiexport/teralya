...
export class ImagenesController{
 ...
 @Post('upload-url') @HttpCode(HttpStatus.OK) autorizar(@CurrentActor() actor:SessionActor,@Param('id') id:string,@Body() body:UploadRequestDto):Promise<UploadAuthorization>{return this.service.autorizar(actor,id,body);}
