  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-nav-groups">
        ...
        <section><h2>Información</h2><nav aria-label="Información legal"><Link href="/legal/terminos">Términos y Condiciones</Link><Link href="/legal/privacidad">Privacidad</Link><Link href="/legal/cookies">Cookies</Link></nav></section>
      </div>
