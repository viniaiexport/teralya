...
export interface BodegaPublic extends BodegaSummary { vinos:WineSummary[];imagen_principal_url?:string;historia?:string;filosofia?:string;anio_fundacion?:number;web?:string;video_url?:string;paises_envio?:string[];plazo_preparacion_dias?:number;plazo_entrega_estimado?:string;coste_envio_descripcion?:string;transportista_habitual?:string;restricciones_entrega?:string;condiciones_empaquetado?:string;capacidad_internacional?:boolean }
