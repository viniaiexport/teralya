...
export default async function WinesPage({ searchParams }: Props) {
  ...
  return <div className="catalog-page premium-catalog-page">
    <header className="catalog-heading editorial-heading"><p className="eyebrow">Selección Teralya</p><h1>Descubre vinos con carácter.</h1><p>Vinos europeos vendidos y enviados directamente por sus bodegas.</p></header>
