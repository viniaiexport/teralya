...
export default async function BuyerAccountPage() {
  ...
  return <section className="private-page account-page">
    <header className="private-heading"><p className="eyebrow">Tu espacio Teralya</p><h1>Bienvenido de nuevo.</h1><p>Consulta tus compras y continúa descubriendo vinos vendidos directamente por sus bodegas.</p></header>
