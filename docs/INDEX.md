...
**Versión 7.1 · 24 de julio de 2026 · Puerta de entrada a la documentación oficial**
...
| OPENAPI | Contrato OpenAPI 3.1 | 1.2 | ✅ APROBADO POR CEO | docs/INF/openapi/teralya-openapi-v1.1.yaml | INF-08 v2.6, INF-08-B, INF-10/10-A v1.1, DLOG 0030 | v1.1 |

## DECISION_LOG

| Código | Nombre | Versión | Estado | Ubicación | Dependencias |
|---|---|---|---|---|---|
| DLOG | Decision Log — Teralya | 2.4 | ✅ OFICIAL, incluye 0001–0030 | docs/DECISION_LOG/Decision_Log.md | CAP-09, INF-06-C, INF-08-B, INF-10 v1.1, ADR-001 a ADR-006 |
...
- Pagos: la comisión se aplica al vino neto de descuentos; la Bodega recibe el resto más transporte e impuestos atribuibles.
...
| LEGAL-03 | Términos y Condiciones de Uso | 1.2 | ✅ APROBADO PARA LA VERSIÓN ACTUAL | docs/LEGAL/LEGAL-03_Terminos_y_Condiciones.md | CAP-02, DLOG 0024–0025/0030 |
| LEGAL-04 | Política de Privacidad (RGPD) | 1.1 | ✅ APROBADO PARA LA VERSIÓN ACTUAL | docs/LEGAL/LEGAL-04_Politica_de_Privacidad_RGPD.md | INF-05/06/06-C, DLOG 0024/0030 |
...
- Backend contract-first completo en la rama de pagos: API-001 a API-056.
...
- OpenAPI 3.1 v1.2: 56 operaciones y 47 paths.
- Stripe Connect, reparto multi-bodega, reversión y documentos económicos implementados; pendientes de evidencia staging y gates live.
...
**OPS-01 — Activación y validación de staging.** El trabajo activo incluye validar Stripe Connect y el reparto real con dos Bodegas de prueba, además de los gates generales del entorno.

### Siguiente paso obligatorio

Ejecutar el recorrido Stripe Connect multi-bodega en staging y cerrar los gates no técnicos de OPS-01: aprobación formal de Seguridad, decisión operativa del CEO ante cobro confirmado sin stock y revisión jurídica/fiscal externa. La activación live requiere además los datos fiscales verificados de Teralya y las Bodegas.
