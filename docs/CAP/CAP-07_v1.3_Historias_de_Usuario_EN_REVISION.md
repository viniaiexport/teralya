...
| 1.3 | 13/07/2026 | CTO + Agente de Producto | EN REVISIÓN | Incorpora la gestión explícita de direcciones e imágenes autorizada en DLOG 0019, sin crear nuevos CU ni HU. |
...
CAP-07 v1.3 queda **EN REVISIÓN**, con las mismas 32 Historias de Usuario y la gestión explícita de Direcciones e Imágenes ya exigidas por el MVP. No se crean nuevos Casos de Uso ni se amplía su alcance.
