...
| Representación persistente y relaciones | INF-05 v1.3, APROBADO POR CTO |
| Significado de campos y reglas técnicas | INF-06 v1.2, APROBADO POR CTO |
...
CAP-02 v1.2 consolida el modelo de datos funcional del MVP y mantiene la separación entre la experiencia comercial del comprador y la operación multi-bodega interna.
...
El documento permanece **EN REVISIÓN** hasta superar la auditoría del CTO. Las reglas persistentes se apoyan en INF-05 v1.3 e INF-06 v1.2 aprobados.
