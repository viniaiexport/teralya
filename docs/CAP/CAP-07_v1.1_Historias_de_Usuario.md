...
| 1.1 | 11/07/2026 | Agente de Producto Teralya | EN REVISIÓN | Reconstrucción trazable desde CAP-03, CAP-04, CAP-05 y CAP-06 vigentes. |

## OBJETIVO

Definir las Historias de Usuario del MVP de Teralya sin ampliar el alcance funcional aprobado. Cada historia deriva de un Caso de Uso de CAP-06 y conserva trazabilidad hacia el módulo de CAP-03, el flujo de CAP-04 y las pantallas de CAP-05 que la materializan.
...
Todas las historias tienen prioridad **MVP — Obligatoria**, porque derivan de Casos de Uso aprobados. La prioridad no establece orden de implementación.
...
- **Actor:** Comprador
- **Historia:** Como comprador autenticado, quiero confirmar mis datos, dirección y resumen de compra, para preparar un Pedido válido antes del pago.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Comprador
- **Historia:** Como comprador, quiero pagar el Pedido mediante Stripe Checkout, para completar la compra y obtener confirmación solo si Stripe aprueba el pago.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Bodega
- **Historia:** Como bodega validada, quiero solicitar la publicación de un vino propio completo, para que el administrador lo revise sin publicarlo directamente yo misma.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Administrador
- **Historia:** Como administrador, quiero consultar una incidencia y actualizarla mediante una transición permitida, para gestionar el problema asociado a un Pedido, una bodega o un vino dentro del alcance básico del MVP.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Sistema
- **Historia:** Como sistema, quiero confirmar un Pedido únicamente tras validar una confirmación correcta de Stripe y la coincidencia del importe, para impedir Pedidos confirmados sin pago aprobado.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Sistema
- **Historia:** Como sistema, quiero agrupar las líneas de un Pedido confirmado por bodega y generar un SubPedido interno para cada una, para dividir correctamente el cumplimiento multi-bodega.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Sistema
- **Historia:** Como sistema, quiero validar autenticación, rol, permisos, validación de bodega y propiedad del recurso, para permitir únicamente los accesos autorizados.
- **Prioridad:** MVP — Obligatoria
...
4. Este documento no define criterios de aceptación. Corresponden a CAP-08 y deberán derivarse de estas 32 historias tras la aprobación de CAP-07 v1.1.

## CIERRE

CAP-07 v1.1 queda completo en estado **EN REVISIÓN**, con 32 Historias de Usuario derivadas de los 32 Casos de Uso oficiales y sin ampliar el alcance del MVP.
