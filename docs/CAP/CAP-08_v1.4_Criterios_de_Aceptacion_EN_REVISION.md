...
| 1.4 | 13/07/2026 | CTO + preparación técnica | EN REVISIÓN | Cierra criterios de sesión Checkout, eventos Stripe y transiciones de SubPedido conforme a DLOG 0020 e INF-08 v2.5. |
...
CAP-08 v1.4 queda **EN REVISIÓN**, con los mismos 103 criterios verificables para HU-001 a HU-032. Precisa pagos y logística sin crear historias, rutas ni funcionalidad adicional.
