...
| 1.3 | 13/07/2026 | CTO + Agente de Producto | APROBADO | Añade criterios verificables para Direcciones e Imágenes conforme a DLOG 0019 e INF-08 v2.4; dictamen binario final APROBABLE. |
| 1.4 | 13/07/2026 | CTO + preparación técnica | APROBADO | Cierra criterios de sesión Checkout, eventos Stripe y transiciones de SubPedido conforme a DLOG 0020 e INF-08 v2.5; doble dictamen APROBABLE. |

## OBJETIVO Y MÉTODO

Definir criterios verificables para HU-001 a HU-032 en formato DADO/CUANDO/ENTONCES. Cada bloque mantiene trazabilidad al módulo de CAP-03, flujo de CAP-04, pantalla de CAP-05 y Caso de Uso de CAP-06 ya asociados en CAP-07 v1.3. Se cubre el resultado principal y las alternativas relevantes sin añadir funcionalidad.
...
**Trazabilidad:** CAP-07 v1.3 HU-001 · CU-001 · ADR-001 · DLOG 0010/0017 · INF-08 v2.5 API-001/API-011.
...
**Trazabilidad:** CAP-07 v1.3 HU-002 · CU-002 · ADR-001 · DLOG 0010/0017 · INF-08 v2.5 API-002/API-011.
...
**Trazabilidad:** CAP-07 v1.3 HU-004 · CU-004 · API-009 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-007 · CU-007 · ADR-001 · API-011 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-008 · CU-008 · ADR-001 · DLOG 0010/0017 · INF-08 v2.5 API-011 a API-015.

### HU-009 — Checkout

**CA-009.1 — Preparación válida:** DADO un comprador autenticado, carrito activo no vacío con líneas válidas y direcciones propias, activas y habilitadas para envío y facturación —que pueden coincidir si admiten ambos usos—, CUANDO confirma datos y resumen, ENTONCES el sistema calcula el total, crea un único Pedido `pendiente_pago` y congela en ese momento los snapshots de envío y facturación.
...
**Trazabilidad:** CAP-07 v1.3 HU-009 · CU-009 · FL-COM-010 · PT-COM-003/PT-COM-004 · INF-08 v2.5 API-016/API-043–046 · DLOG 0010/0016/0019.
...
**Trazabilidad:** CAP-07 v1.3 HU-011 · CU-011 · API-019/API-020 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-014 · CU-014 · FL-BOD-004 · PT-BOD-001/PT-BOD-002/PT-PUB-004 · INF-08 v2.5 API-006/API-031/API-043–046 · DLOG 0019.
...
**Trazabilidad:** CAP-07 v1.3 HU-015 · CU-015 · API-007 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-016 · CU-016 · FL-BOD-006 · PT-BOD-003/PT-BOD-005/PT-BOD-006 · INF-08 v2.5 API-008/API-033/API-047–050 · DLOG 0019.
...
**Trazabilidad:** CAP-07 v1.3 HU-017 · CU-017 · API-034 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-018 · CU-018 · API-021/API-022 · INF-08 v2.5.

### HU-019 — Cambio de estado de SubPedido

**CA-019.1 — Transición válida:** DADO un SubPedido propio, CUANDO la bodega solicita `pendiente→aceptado|cancelado|incidencia`, `aceptado→en_preparacion|cancelado|incidencia`, `en_preparacion→enviado|cancelado|incidencia`, `incidencia→en_preparacion|cancelado` o `enviado→entregado`, ENTONCES actualiza `subpedido.estado` y recalcula el Pedido en la misma transacción. Solicitar el mismo estado devuelve 200 sin nuevo cambio.

**CA-019.2 — Transición no permitida:** DADO un SubPedido ajeno, un salto no enumerado o un intento de salir de `entregado` o `cancelado`, CUANDO se intenta cambiar el estado, ENTONCES devuelve el error aplicable —409 para transición inválida— y no modifica el SubPedido ni el Pedido global.
...
**Trazabilidad:** CAP-07 v1.3 HU-021 · CU-021 · API-024/API-035/API-036 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-022 · CU-022 · API-037/API-038 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-023 · CU-023 · API-025 · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-027 · CU-027 · DLOG 0015 · INF-08 v2.5 API-040/API-041/API-042.

## SISTEMA

### HU-028 — Confirmación de Pedido tras el pago

**CA-028.1 — Confirmación válida:** DADO un Pedido `pendiente_pago` y `checkout.session.completed` con `payment_status=paid` o `checkout.session.async_payment_succeeded`, firmado, único y con sesión, pedido, pago, importe y moneda coincidentes, CUANDO API-029 lo procesa, ENTONCES actualiza `pago.estado`, conserva snapshots de direcciones, congela líneas y precios y genera atómicamente los SubPedidos.

**CA-028.2 — Evento sin confirmación:** DADO `checkout.session.completed` aún no pagado, `checkout.session.async_payment_failed`, `checkout.session.expired`, firma inválida, evento fuera de allowlist o datos discrepantes, CUANDO se procesa, ENTONCES no se generan SubPedidos ni se aplica stock; los eventos fallido/expirado actualizan únicamente el estado económico autorizado y un tipo no admitido devuelve 422.
...
**Trazabilidad:** CAP-07 v1.3 HU-029 · CU-029 · DLOG 0016 · INF-08 v2.5 API-029.
...
**Trazabilidad:** CAP-07 v1.3 HU-031 · CU-031 · regla transversal de acceso · INF-08 v2.5.
...
**Trazabilidad:** CAP-07 v1.3 HU-032 · CU-032 · regla transversal de respuestas 403/404/409 · INF-08 v2.5.

## MATRIZ RESUMEN

| Rango | Actor | Historias | Criterios | Fuentes principales |
|---|---|---:|---:|---|
| HU-001 a HU-011 | Comprador | 11 | 41 | CU-001 a CU-011 |
| HU-012 a HU-019 | Bodega | 8 | 23 | CU-012 a CU-019 |
| HU-020 a HU-027 | Administrador | 8 | 19 | CU-020 a CU-027 |
| HU-028 a HU-032 | Sistema | 5 | 20 | CU-028 a CU-032 |
| **Total** |  | **32** | **103** | **CU-001 a CU-032** |

## OBSERVACIONES DE REVISIÓN

1. Los 103 criterios cubren las 32 historias sin forzar una relación de un único criterio por historia.
...
4. La aprobación requiere trazabilidad coherente con CAP-02 v1.3, CAP-07 v1.3, INF-08 v2.5, ADR-001 y DLOG 0010/0014–0020.

## CIERRE

CAP-08 v1.4 queda **APROBADO POR EL CTO**, con los mismos 103 criterios verificables para HU-001 a HU-032. Precisa pagos y logística sin crear historias, rutas ni funcionalidad adicional.
