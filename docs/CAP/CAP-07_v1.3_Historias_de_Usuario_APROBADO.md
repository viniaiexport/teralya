...
| 1.2 | 13/07/2026 | CTO Teralya | APROBADO | Alineación con ADR-001, DLOG 0010/0014–0016, CAP-02 v1.2 e INF-08 v2.2. |
| 1.3 | 13/07/2026 | CTO + Agente de Producto | APROBADO | Incorpora la gestión explícita de direcciones e imágenes autorizada en DLOG 0019, sin crear nuevos CU ni HU; dictamen binario final APROBABLE. |
...
- **Actor:** Comprador
- **Historia:** Como comprador autenticado, quiero crear, consultar, actualizar y desactivar lógicamente mis direcciones de envío y facturación, seleccionar dos direcciones activas y confirmar el resumen de compra, para preparar un único Pedido pendiente de pago por Carrito sin duplicarlo ante reintentos.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Bodega
- **Historia:** Como bodega validada, quiero completar y editar mi perfil y gestionar lógicamente mis direcciones propias, para mantener correcta la información comercial y operativa que genera confianza en los compradores.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Bodega
- **Historia:** Como bodega validada, quiero editar únicamente un vino propio y gestionar sus imágenes confirmadas y activas mediante carga directa autorizada, metadatos, orden, imagen principal y desactivación lógica, para mantener correcta su información antes de solicitar publicación.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Bodega
- **Historia:** Como bodega validada, quiero solicitar la publicación de un vino propio completo y con al menos una imagen confirmada y activa, para que el administrador lo revise, quedando el vino en estado `pendiente_revision` sin publicarlo directamente yo misma.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Administrador
- **Historia:** Como administrador, quiero revisar un vino pendiente y comprobar su integridad, precio, disponibilidad, imágenes confirmadas y activas y bodega validada, para decidir si puede publicarse.
- **Prioridad:** MVP — Obligatoria
...
- **Actor:** Administrador
- **Historia:** Como administrador, quiero publicar un vino completo en estado `pendiente_revision`, con al menos una imagen confirmada y activa y perteneciente a una bodega validada, para hacerlo visible y comprable en el catálogo.
- **Prioridad:** MVP — Obligatoria
...
|---|---|---|---:|
| HU-001 a HU-011 | Comprador (Visitante en HU-007/008) | CU-001 a CU-011 | 11 |
...
- La propiedad de Direcciones e Imágenes se deriva de la sesión autenticada; no se aceptan identificadores arbitrarios de propietario. Las eliminaciones son desactivaciones lógicas y conservan el histórico comercial.
...
CAP-07 v1.3 queda **APROBADO POR EL CTO**, con las mismas 32 Historias de Usuario y la gestión explícita de Direcciones e Imágenes ya exigidas por el MVP. No se crean nuevos Casos de Uso ni se amplía su alcance.
