...
**Versión 1.3 · Estado: APROBADO POR EL CTO · Basado en `teralya_schema_v1.4_APROBADO.sql` · Julio 2026**

Actualización 1:1 sobre INF-05 v1.4 aprobada. Documenta 19 tablas, tipos exactos, claves, restricciones, índices, funciones y triggers sin ampliar el MVP.
...
| 1.3 | 13/07/2026 | CTO + Arquitecto de Datos | APROBADO | Alineación 1:1 con INF-05 v1.4 y DLOG 0017; añade CARRITO_FUSION inmutable. |
...
- Fuente técnica normativa: `teralya_schema_v1.4_APROBADO.sql`, versión 1.4, estado APROBADO POR EL CTO.
