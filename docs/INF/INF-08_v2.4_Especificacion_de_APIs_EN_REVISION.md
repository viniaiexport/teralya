...
**Teralya · Versión 2.4 · 13/07/2026 · EN REVISIÓN**
...
INF-08 v2.4 queda **EN REVISIÓN** con 50 operaciones en 11 módulos. API-001 a API-042 conservan sus códigos, métodos y rutas. API-043 a API-050 formalizan Direcciones e Imágenes ya exigidas por el MVP. Su aprobación requiere dictamen binario de los dos revisores técnicos.
