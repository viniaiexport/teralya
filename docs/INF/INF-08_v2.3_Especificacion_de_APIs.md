...
**Teralya · Versión 2.3 · 13/07/2026 · APROBADO POR EL CTO**
...
**Validaciones**
El vino existe y está exactamente en `pendiente_revision`; tiene información obligatoria completa, precio y disponibilidad válidos y al menos una imagen; la bodega propietaria está validada.
