...
**Teralya · Versión 2.0 · Julio 2026 · Preparado por Claude · APROBACIÓN DEFINITIVA**
...
**Validaciones**
Comprador autenticado. Carrito no vacío. Datos obligatorios completos. Dirección de envío válida. Disponibilidad revalidada.
...
**Observaciones**
No se inicia el pago si el checkout no es válido.
...
**Validaciones**
El Pedido está preparado para pago. El importe es válido.
...
**Observaciones**
El Pedido solo se confirma cuando el sistema recibe la confirmación correcta de Stripe (ver Webhook de Stripe).
