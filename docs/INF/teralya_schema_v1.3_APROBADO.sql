...
-- PostgreSQL · Versión 1.3 · Julio 2026 · Estado: APROBADO POR EL CTO
-- Autor: Claude · Basado en: Capítulo 1 - Entidades del MVP
-- Evolución v1.3: corrige estados de publicación, fuente de verdad del
--   pago, idempotencia de Checkout/Stripe, integridad cruzada entre
--   Pedido, Pago, SubPedido y líneas, restricciones de importes/stock,
--   roles, incidencias e índices operativos. Incorpora el ledger técnico
--   mínimo de eventos webhook de Stripe.
