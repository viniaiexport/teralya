...
**Versión 1.0 · Basado en `teralya_schema_v1.1_APROBADO.sql` · Julio 2026**
Generado directamente a partir del esquema aprobado por el CTO — no se ha modificado ninguna decisión de diseño. Referencia oficial para desarrollo, Lovable e integraciones futuras.

## Índice

1. BODEGA · 2. USUARIO · 3. COMPRADOR · 4. CUENTA_STRIPE_CONNECT · 5. VINO · 6. IMAGEN · 7. DIRECCION · 8. CARRITO · 9. CARRITO_ITEM · 10. PEDIDO · 11. PAGO · 12. SUBPEDIDO · 13. PEDIDO_ITEM · 14. NOTIFICACION · 15. AUDITORIA
...
*Documento preparado por Claude, generado a partir del esquema SQL real y verificado contra una instancia de PostgreSQL 16 — no es una transcripción manual. No modifica ninguna decisión del modelo aprobado en INF-05.*