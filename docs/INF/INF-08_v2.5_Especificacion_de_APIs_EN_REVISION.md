...
**Teralya · Versión 2.5 · 13/07/2026 · EN REVISIÓN**
...
INF-08 v2.5 queda **EN REVISIÓN** con las mismas 50 operaciones y 11 módulos de v2.4. Se precisan API-017, API-023 y API-029 conforme a DLOG 0020; todos los códigos, métodos y rutas permanecen intactos. Requiere dictamen binario final.
