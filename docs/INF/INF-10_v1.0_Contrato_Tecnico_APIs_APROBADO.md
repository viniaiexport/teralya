...
|---|---|---|---|---|
| 1.0 | 13/07/2026 | CTO + preparación técnica | APROBADO POR EL CTO | Gobernanza, invariantes, DTO y OpenAPI 3.1 validados; cobertura exacta API-001→050. |
...
INF-08 v2.5 y CAP-08 v1.4 están APROBADOS POR EL CTO como correcciones coordinadas autorizadas por DLOG 0020. INF-10 definirá el contrato wire. El YAML OpenAPI aprobado es la fuente normativa de schemas y no se duplican sus definiciones completas en este Markdown.
...
3. `docs/INF/openapi/teralya-openapi-v1.0.yaml`: contrato OpenAPI 3.1 aprobado, generado literalmente desde INF-10/INF-10-A.
...
Estas convenciones están incorporadas al YAML aprobado:
...
Proyecciones públicas nunca muestran stock exacto, comisiones, verificación, credenciales, Stripe, auditoría ni direcciones privadas. INF-10-A v1.0 enumera exhaustivamente cada propiedad permitida, obligatoriedad, tipo, nullability, readOnly/writeOnly y límite, además del request, éxito y errores de API-001→050. El YAML materializa ese catálogo literalmente y no decide ni añade campos.

## Validación y aprobación final

- OpenAPI 3.1.0 y JSON Schema 2020-12.
- 50 operaciones únicas, 41 paths, 11 módulos y 74 schemas.
- Trazabilidad CU/PT incorporada en cada operación.
- Referencias internas resueltas; ejemplos, seguridad y matriz de respuestas validados.
- Validador contractual propio: conforme.
- Redocly: válido, cero advertencias.
- Spectral OAS: cero errores y cero advertencias.
- SHA-256 del YAML aprobado: `7bf2997c3d15bd919b7ecab7686cea7569e637f5786cdd124851eb679de9a175`.
- Dictámenes independientes: Newton **APROBABLE**; Leibniz **APROBABLE**.

INF-10 v1.0 y `teralya-openapi-v1.0.yaml` quedan **APROBADOS POR EL CTO**. No se modifican códigos, métodos ni rutas de API-001→050; INF-07, INF-09 y ADR permanecen cerrados.
