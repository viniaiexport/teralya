...
**Teralya · Versión 2.5 · 13/07/2026 · APROBADO POR EL CTO**

*INF-08 v2.5: corrección semántica autorizada por DLOG 0020 para retirar el 402 impropio de API-017, fijar la matriz exacta de API-023 y cerrar la allowlist y efectos de API-029. Conserva los 50 códigos, métodos y rutas de v2.4 en 11 módulos; no añade funcionalidad ni cambia topología.*
...
INF-08 v2.5 queda **APROBADO POR EL CTO** con las mismas 50 operaciones y 11 módulos de v2.4. API-017, API-023 y API-029 quedan precisadas conforme a DLOG 0020; todos los códigos, métodos y rutas permanecen intactos. Los dos revisores emitieron dictamen APROBABLE.
