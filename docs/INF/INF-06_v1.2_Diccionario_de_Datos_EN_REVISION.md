...
**Versión 1.2 · Estado: EN REVISIÓN · Basado en `teralya_schema_v1.3_APROBADO.sql` · Julio 2026**

Reconstrucción completa 1:1 sobre INF-05 v1.3 aprobada. Documenta 18 tablas, tipos exactos, claves, restricciones, índices, funciones y triggers sin ampliar el MVP.
...
| 1.2 | 13/07/2026 | CTO Teralya | EN REVISIÓN | Reconstrucción completa sobre INF-05 v1.3; incorpora Decisiones 0014–0016. |
...
- Fuente técnica normativa: `teralya_schema_v1.3_APROBADO.sql`, versión 1.3, estado APROBADO POR EL CTO.
...
1. BODEGA · 2. USUARIO · 3. COMPRADOR · 4. CUENTA_STRIPE_CONNECT · 5. VINO · 6. IMAGEN · 7. DIRECCION · 8. CARRITO · 9. CARRITO_ITEM · 10. PEDIDO · 11. PAGO · 12. EVENTO_WEBHOOK_STRIPE · 13. SUBPEDIDO · 14. PEDIDO_ITEM · 15. INCIDENCIA · 16. NOTIFICACION · 17. AUDITORIA · 18. SOLICITUD_RECUPERACION_PASSWORD
...
## 18. SOLICITUD_RECUPERACION_PASSWORD
...
Total normativo: **13 funciones y 29 triggers**.

## Índices y claves operativas añadidos

- `uq_usuario_email_normalizado`.
- `idx_carrito_comprador_id`, `idx_carrito_item_carrito_id`, `idx_carrito_item_vino_id`.
...
| Elemento | INF-05 v1.3 | INF-06 v1.2 |
|---|---:|---:|
| Tablas | 18 | 18 |
| Tipos ENUM | 19 | 19 |
| Funciones | 13 | 13 |
